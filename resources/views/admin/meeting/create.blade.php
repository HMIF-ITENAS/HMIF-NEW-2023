      ...
      <div class="fade-in">
        <div class="card">
            <div class="card-header">
                ...
                <strong>Buat Rapat</strong>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="{{ route('admin.meeting.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                  <label class="col-md-3 col-form-label" for="title-input">Nama Rapat</label>
                  <div class="col-md-9">
                    <input class="form-control @error('name') is-invalid @enderror" id="name-input" type="text" name="name" placeholder="Masukkan nama meeting" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input class="form-control @error('detail') is-invalid @enderror" id="detail-input" type="text" name="detail" placeholder="Masukkan detail" value="{{ old('detail') }}">
                    @error('detail')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <select id="meeting_category" name="meeting_category_id" class="form-control @error('meeting_category_id') is-invalid
                      @enderror">
                            <option></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input id="begin_date" class="form-control @error('begin_date') is-invalid @enderror" type="text" name="begin_date" placeholder="Masukkan tanggal mulai" value="{{ old('begin_date') }}" required>
                      @error('begin_date')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input id="start_meet_at" class="form-control @error('start_meet_at') is-invalid @enderror" type="time" name="start_meet_at" placeholder="Masukkan jam mulai" value="{{ old('start_meet_at') }}" required>
                      @error('start_meet_at')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input id="end_meet_at" class="form-control @error('end_meet_at') is-invalid @enderror" type="time" name="end_meet_at" placeholder="Masukkan jam mulai" value="{{ old('end_meet_at') }}">
                      @error('end_meet_at')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                ...
                <div id="start_presence_container" class="form-group row d-none">
                    ...
                    <div class="col-md-9">
                      <input id="start_presence" class="form-control @error('start_presence') is-invalid @enderror" type="time" name="start_presence" placeholder="Masukkan absen mulai" value="{{ old('start_presence') }}">
                ...
                <div id="end_presence_container" class="form-group row d-none">
                    ...
                    <div class="col-md-9">
                      <input id="end_presence" class="form-control @error('end_presence') is-invalid @enderror" type="time" name="end_presence" placeholder="Masukkan absen mulai" value="{{ old('end_presence') }}">
                      @error('end_presence')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
