              ...
              <form class="form-horizontal" action="{{ route('admin.post.update', $post->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    ...
                    @enderror" id="title-input" type="text" name="title" placeholder="Masukkan Judul" value="{{ old('title') ?? $post->title}}">
                    @error('title')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="file" class="dropify form-control" name="banner" id="banner" data-max-file-size="10M" data-allowed-file-extensions="jpg png jpeg" data-default-file="{{ $post->getBanner() }}">
                        @error('banner')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
