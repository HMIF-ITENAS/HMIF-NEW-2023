...
@section('content')
    <style>
        ...
        .btn.btn-success.user_detail:hover {
           filter: brightness(120%);
        }

        .btn.btn-info.user_edit {
            color: #2c7adc;
        ...
        <div class="container-fluid">
            <div class="fade-in">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-responsive-md table-hover table-outline table-md" id="users-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
