            ...
            <div class="card-body">
              <form class="form-horizontal" action="{{ route('admin.users.update', $user->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input class="form-control @error('nrp') is-invalid @enderror" id="from-input" type="text" name="nrp" placeholder="Masukkan NRP" value="{{ old('nrp') ?? $user->nrp }}">
                    @error('nrp')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <input class="form-control @error('angkatan') is-invalid @enderror" id="title-input" type="text" name="angkatan" placeholder="Masukkan Angkatan" value="{{ old('angkatan') ?? $user->angkatan }}">
                    @error('angkatan')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                    <input class="form-control @error('email') is-invalid @enderror" id="title-input" type="email" name="email" placeholder="Masukkan Email" value="{{ old('email') ?? $user->email }}">
                        @error('content')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
