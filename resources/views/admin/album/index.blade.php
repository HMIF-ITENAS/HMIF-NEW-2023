...
@section('content')
    <style>
        ...
        .btn.btn-success.album_detail:hover {
           filter: brightness(120%);
        }

        .btn.btn-info.album_edit {
            color: #2c7adc;
        ...
        <div class="container-fluid">
            <div class="fade-in">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-responsive-md table-hover table-outline table-md" id="album-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
