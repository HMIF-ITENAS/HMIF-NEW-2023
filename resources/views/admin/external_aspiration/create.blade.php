            ...
            <div class="fade-in">
                <div class="card">
                    <div class="card-header">
                        ...
                        Buat Aspirasi Eksternal
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.aspiration.external.store') }}" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control @error('from') is-invalid @enderror" id="from-input"
                                        type="text" name="from" placeholder="Masukkan instansi"
                                        value="{{ old('from') }}">
                                    @error('from')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
