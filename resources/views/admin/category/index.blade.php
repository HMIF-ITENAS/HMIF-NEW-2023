...
@section('content')
    <style>
        ...
        .btn.btn-success.category_detail {
            color: #56a22a;
        ...
        .btn.btn-success.category_detail:hover {
            filter: brightness(120%);
        }

        .btn.btn-info.category_edit {
            color: #2c7adc;
        ...
        .btn.btn-info.category_edit:hover {
            filter: brightness(120%);
        }
        ...
        <div class="container-fluid">
            <div class="fade-in">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-responsive-md table-hover table-outline table-md" id="category-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
