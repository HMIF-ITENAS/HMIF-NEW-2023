                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal"
                            action="{{ route('admin.meeting_category.update', $meetingCategory->id) }}" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control @error('name') is-invalid @enderror" id="name-input"
                                        type="text" name="name" placeholder="Masukkan nama kategori meeting"
                                        value="{{ old('name') ?? $meetingCategory->name }}">
                                    @error('name')
                      ...
                      @enderror">
                                        <option></option>
                                        <option value="1" @if ($meetingCategory->status == 1) selected @endif>Aktif
                                        </option>
                                        <option value="0" @if ($meetingCategory->status == 0) selected @endif>Tidak Aktif
                                        </option>
                                    </select>
                                    @error('status')
                                        <span class="invalid-feedback" role="alert">
