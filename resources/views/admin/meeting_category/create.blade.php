      ...
      <div class="fade-in">
        <div class="card">
            <div class="card-header">
                ...
                <strong>Buat Kategori Rapat</strong>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="{{ route('admin.meeting_category.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                  <label class="col-md-3 col-form-label" for="title-input">Nama Kategori Rapat</label>
                  <div class="col-md-9">
                    <input class="form-control @error('name') is-invalid @enderror" id="name-input" type="text" name="name" placeholder="Masukkan nama kategori meeting" value="{{ old('name') }}">
                    @error('name')
