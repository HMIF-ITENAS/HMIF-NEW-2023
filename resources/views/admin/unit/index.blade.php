...
@section('content')
    <style>
        ...
        .btn.btn-success.unit_detail:hover {
           filter: brightness(120%);
        }

        .btn.btn-info.unit_edit {
            color: #2c7adc;
        ...
        <div class="container-fluid">
            <div class="fade-in">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-responsive-md table-hover table-outline table-md" id="unit-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
