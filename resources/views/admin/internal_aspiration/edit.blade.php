      ...
      <div class="fade-in">
        <div class="card">
            <div class="card-header">
                ...
                <strong>Edit Aspirasi Internal</strong>
            </div>
            <div class="card-body">
              <form class="form-horizontal" action="{{ route('admin.aspiration.internal.update', $aspiration->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      ...
                      @enderror">
                            <option></option>
                            <option value="public" @if($aspiration->privacy === "public") selected @endif>Publik</option>
                            <option value="private" @if($aspiration->privacy === "private") selected @endif>Privat</option>
                      </select>
                        @error('privacy')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
