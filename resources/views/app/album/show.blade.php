        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($album->photos as $photo)
                    <a href="{{ asset('assets/album/' . $album->slug . '/' . $photo->photo) }}" data-toggle="lightbox"
                        data-gallery="gallery" class="col-md-3 pb-3">
                        <img src="{{ asset('assets/album/' . $album->slug . '/' . $photo->photo) }}"
