        ...
        <div class="container">
            <div class="section-intro pb-5 text-center">
                ...
                <p class="section-intro__subtitle">
                    Berikut ini adalah Visi dan Misi Himpunan Mahasiswa Teknik Informatika Periode 2022-2023
                </p>
            </div>
            ...
            <div class="row">
                <h1>Visi</h1>
                <p>
                    Menjadikan HMIF sebagai wadah yang produktif dan nyaman bagi seluruh anggota untuk berkarya
                    dan berkontribusi pada pengembangan sumber daya manusia (SDM) di bidang Informatika.
                </p>
            </div>
            <div class="row">
                <h1>Misi</h1>
                <ol>
                    <li>Menjalin hubungan yang harmonis dengan seluruh anggota HMIF, dengan mengedepankan komunikasi yang
                        terbuka, transparan, dan menghargai keragaman. </li>
                    <li>Meningkatkan keterlibatan anggota dalam organisasi dan memfasilitasi partisipasi aktif dalam
                        kegiatan yang menunjang peningkatan kualitas SDM. </li>
                    <li>Membangun lingkungan organisasi yang inklusif, kolaboratif, dan mendukung pengembangan potensi
                        anggota. </li>
                    <li>Memberikan Apresiasi atas kontribusi anggota dalam kegiatan yang telah dilakukan.</li>
                </ol>
            </div>
        </div>
    </section>
