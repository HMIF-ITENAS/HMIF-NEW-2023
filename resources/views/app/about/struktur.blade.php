...
<section class="section-padding--small bg-magnolia">
    <div class="container-fluid">
        <div class="section-intro pb-5 text-center">
            ...
            <p class="section-intro__subtitle">Berikut ini adalah struktur organisasi dari Badan Pengurus Himpunan Mahasiswa Teknik Informatika (BP HMIF).</p>
        </div>
        ...
        <div class="section-intro pb-5 text-center">
            ...
            <p class="section-intro__subtitle">Berikut ini adalah struktur organisasi dari Badan Perwakilan Anggota Himpunan Mahasiswa Teknik Informatika (BPA HMIF).</p>
        </div>
        <div class="align-items-center mb-5">
            <div class="text-center text-lg-left mb-4 mb-lg-0">
                <img class="img-fluid" src="{{ asset('app/img/struktur-bp.png') }}" alt="">
