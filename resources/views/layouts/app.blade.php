    ...
    <div class="container">
        ...
        <div class="col-md-7 single-footer-widget">
          ...
          <ul>
            <li>
                ...
                <a href="https://goo.gl/maps/CBAPRHdH8kWudzt99" target="_blank">Jl. Phh. Mustofa No. 23, Bandung, Jawa Barat 40123. Sekretariat: Gedung 2 lantai 2</a>
            </li>
            <li>
      ...
      <div class="footer-bottom row align-items-center text-center text-lg-left">
        <p class="footer-text m-0 col-lg-8 col-md-12">
          ...
          Copyright &copy;
          <script>document.write(new Date().getFullYear());</script> All rights reserved | <b>HMIF Dev's</b>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        </p>
